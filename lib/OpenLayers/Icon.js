...
OpenLayers.BootstrapIcon = OpenLayers.Class({
     ...
     * calculateOffset - {Function} 
     */
    initialize: function(name, id, color, classNames, size, offset, calculateOffset, extraCss) {
        ...
        if (!id) {
            id = OpenLayers.Util.createUniqueID("OL_Icon_");
        } else {
            element.setAttribute('href','#event-marker');
        ...
        if(extraCss && typeof(extraCss)==="string"){
            element.style.cssText += extraCss;
        }
     ...
     */
    clone: function() {
        return new OpenLayers.HTMLIcon(this.size, 
                                   this.offset, 
                                   this.calculateOffset);
    },
    ...
    setOpacity: function(opacity) {
        ...
        OpenLayers.Util.modifyDOMElement(this.imageDiv, null, null, null, null, null, null, opacity);
    },
